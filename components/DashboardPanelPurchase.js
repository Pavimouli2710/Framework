...
const DashboardPanelPurchase = (props) => {
  const purchaseelements = useSelector((state) => {
    return state.dashboardPanel.purchaseelements;
  });
...
export default DashboardPanelPurchase;
