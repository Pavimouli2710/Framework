...
const DashboardPanelIncident = (props) => {
    const incidentelements = useSelector((state) => {
        return state.dashboardPanel.incidentelements;
      });
...
export default DashboardPanelIncident;
