...
const DashboardPanelPlannedMaintenance = (props) => {
  const plannedmaintenanceelements = useSelector((state) => {
    return state.dashboardPanel.plannedmaintenanceelements;
  });
    ...
    <View style={{ margin: 10 }}>
      <View style={{ marginTop: 5 }}>
        <FlatList
          ...
          data={plannedmaintenanceelements}
...
export default DashboardPanelPlannedMaintenance;
